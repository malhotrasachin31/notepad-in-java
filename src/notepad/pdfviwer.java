 ...
 * @author User
 */
public class pdfviwer extends javax.swing.JFrame {
    /**
     * Creates new form Help
     */
    public pdfviwer() {
        initComponents();
         openpdf("Documents\\salesreports.pdf");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pdfviwer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
